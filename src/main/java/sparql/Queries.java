...
public enum Queries {
	...
	ABSTRACTLINKS("SELECT * WHERE {"
			...
			+ "    <http://www.w3.org/2005/11/its/rdf#taIdentRef> ?taIdentRef; "
			+ "    <http://persistence.uni-leipzig.org/nlp2rdf/ontologies/nif-core#superString> ?lsuper; "
			+ "    <http://persistence.uni-leipzig.org/nlp2rdf/ontologies/nif-core#beginIndex> ?beginIndex; "
			+ "    <http://persistence.uni-leipzig.org/nlp2rdf/ontologies/nif-core#endIndex> ?endIndex. "
